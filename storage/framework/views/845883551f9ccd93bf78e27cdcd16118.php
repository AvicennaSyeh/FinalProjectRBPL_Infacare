    ...
    <body>
        ...
        <div class="card" style="background-color: #F0CDC4">
            <div class="card-baris-1">
                ...
                <?php $__currentLoopData = json_decode(json_encode($chunks), true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row">
                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nurse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 bentuk-card">
                                <img src="<?php echo e($imageURL); ?>" alt="Profile Image" class="person-img" onclick="showPopup(<?php echo e($nurse['id']); ?>)">
                                <p style="font-weight: bolder; font-size: 22px; font-family: 'Poppins';">
                                    <?php echo e($nurse['namaNurse']); ?></p>
                                ...
                                <img src="images/icon tambah.png" alt=""
                                    style="position: relative; width: 23px;height: 23px; left: 100px; top: -70px" onclick="redirectToNurseRent(<?php echo e($nurse['id']); ?>)">
        ...
        <script>
            ...
            function showPopup(id) {
                ...
                var nurses = <?php echo json_encode($nurses, 15, 512) ?>;
                ...
                popupImage.src = "<?php echo e(asset('images/nurse/nurse')); ?>" + currentNurse.id + ".jpg";
                popupImage.onerror = function() {
                    this.src = "<?php echo e(asset('images/nurse.jpg')); ?>";
                };
                ...
                for (var i = 1; i <= 5; i++) {
                    ...
                    if (i <= Math.round(currentNurse.ratingNurse)) {
                        img.src = "<?php echo e(asset('images/icon_bintang_berisi.png')); ?>";
                    } else {
                        img.src = "<?php echo e(asset('images/icon_bintang_kosong.png')); ?>";
                    }
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/infanurse2.blade.php ENDPATH**/ ?>