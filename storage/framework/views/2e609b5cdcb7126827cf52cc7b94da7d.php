            ...
            <div class="card mb-3" style="width: 25rem; height: fit-content;">
                <div class="row g-0">
                    <div class="col-md-4">
                        ...
                        ?>
                        <img src="<?php echo e($imageURL); ?>" class="img-fluid rounded-start py-4" alt=""
                            style="width: 110px;">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title mt-3"><?php echo e($latestNurse->namaNurse); ?></h5>
                            <p class="card-text text-muted"><?php echo e($latestNurse->asal); ?></p>
                            <p><?php echo e($latestNurse->reviewNurse); ?></p>
                            <link rel="stylesheet"
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/home.blade.php ENDPATH**/ ?>