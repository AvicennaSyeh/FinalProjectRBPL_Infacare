            ...
            <div class="container-fluid bg-light-pink" id="bg-light-pink">
                ...
                <div class="container w-50 mt-5" id="about-me">
                    <div class="card rounded-0">
                        ...
                        <div class="card-body px-5  bg-light-pink-3">
                            <div class="row">
                                ...
                                <div class="col-lg-8" style="font-family:Lexend; opacity: 90%; margin-bottom: 10px;">
                                    <?php echo e($user->birthday_day); ?> <?php echo e($user->birthday_month); ?> <?php echo e($user->birthday_year); ?>
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <a href="<?php echo e(route('userprofile')); ?>" class="btn fw-semi bold mx-3" style="font-family: Lexend">Edit Profile</a>
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/showuserprofile.blade.php ENDPATH**/ ?>