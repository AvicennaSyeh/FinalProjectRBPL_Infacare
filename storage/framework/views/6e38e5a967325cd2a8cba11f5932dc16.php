        ...
        <div class="mx-[165px] my-12">
            ...
            <div class="w-full px-8 mt-6 items-center relative text-center font-lexend grid grid-cols-5  h-40 bg-white">
                ...
                <div class="col-span-1 text-left ml-4">
                    <div class="flex flex-col">
                        <h1 class="text-xl"><?php echo e($barang->namaBarang); ?></h1>
                        <p class="text-[#677489]"><?php echo e($barang->lokasi); ?></p>
                    </div>
                </div>
            ...
            <div class="fixed bottom-0 bg-white font-sparta w-[1040px] h-32">
                <div class="flex flex-row mx-6 gap-4 justify-end items-center h-full">
                    ...
                    <form id="rentForm" action="<?php echo e(route('submit-rent')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="perlengkapanBayiId" value="<?php echo e($barang->id); ?>">
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/rentCart2.blade.php ENDPATH**/ ?>