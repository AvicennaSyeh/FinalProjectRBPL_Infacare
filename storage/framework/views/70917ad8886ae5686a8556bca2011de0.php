    ...
    <body class="bg-[#FFF1C7]">
        ...
        <div class="mx-[165px] my-12">
            <div class="flex flex-row gap-12">
                <a href="infanurse"><img class="" src="<?php echo e(asset('images/back.svg')); ?>"> </a>
            ...
            <div class="w-full px-8 mt-6 items-center relative text-center font-lexend grid grid-cols-5  h-40 bg-white">
                ...
                <img src="<?php echo e($imageURL); ?>" alt="Profile Image" class="person-img"
                    onclick="redirectToNurseRent(<?php echo e($nurse->id); ?>)" style="scale: 0.7; top:-16px; position: relative;">

                <div class="col-span-1 text-left  ml-4">
                    <div class="flex flex-col">
                        <h1 class="text-xl"><?php echo e($nurse->namaNurse); ?></h1>
                        <p class="text-[#677489]"><?php echo e($nurse->asal); ?></p>
                    </div>
                </div>

                <h1 id="harga" class="text-[#5A5A5A] col-span-1" data-harga="<?php echo e($harga !== null ? $harga : 'Null'); ?>">
                    Rp<?php echo e($harga !== null ? number_format($harga, 0, ',', '.') : 'Null'); ?>
                ...
                <div class="col-span-1">
                    <div class="flex items-center justify-center">
                        ...
                        <span id="countDisplay"
                            class="text-2xl px-6 py-[6px] ring-1 ring-gray-200"><?php echo e($count); ?></span>
                ...
                <a class="absolute right-8 w-10" href="/infanurse">
                    <img src="<?php echo e(asset('images/del-icon.svg')); ?>" alt="">
                </a>
            </div>
            <!-- Akhir foreach -->
            ...
            <div class="fixed bottom-0 bg-white font-sparta w-[1040px] h-32">
                <div class="flex flex-row mx-6 gap-4 justify-end items-center h-full">
                    ...
                    <form id="rentForm" action="<?php echo e(route('submit-nurserent')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="nurseId" value="<?php echo e($nurseId); ?>">
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/nurserent.blade.php ENDPATH**/ ?>