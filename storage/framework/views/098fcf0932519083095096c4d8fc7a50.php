    ...
    <body class="bg-[#FFF1C7]">
        ...
        <div class="mx-[165px] my-12">
            <div class="flex flex-row gap-12">
                <img class="" src="<?php echo e(asset('images/back.svg')); ?>">
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\rbpl-project-infagrowth\resources\views/nurserent.blade.php ENDPATH**/ ?>