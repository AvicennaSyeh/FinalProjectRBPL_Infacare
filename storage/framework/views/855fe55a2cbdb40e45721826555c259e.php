<?php $__env->startSection('content'); ?>
    ...
    <body>
        ...
        <section class="container">
            ...
            <form id="form1" action="<?php echo e(route('profilepicture.upload')); ?>" method="POST" enctype="multipart/form-data" class="form">
                <?php echo csrf_field(); ?>
                ...
                <div class="profile-picture">
                    <?php if(Auth::user()->profile_picture): ?>
                        <img src="<?php echo e(asset('storage/profile_pictures/' . Auth::user()->profile_picture)); ?>"
                            alt="Profile Picture">
            ...
            <form id="form2" method="POST" action="<?php echo e(route('save-profile')); ?>" enctype="multipart/form-data" class="form">
                <?php echo csrf_field(); ?>
                ...
                <!--<form action="<?php echo e(route('profile.password.verify')); ?>" method="POST">-->
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- <script>
                ...
                passwordInput.addEventListener('input', function() {
                    ...
                    xhr.open('POST', '<?php echo e(route('profile.password.verify')); ?>', true);
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\rbpl-project-infagrowth\resources\views/userprofile.blade.php ENDPATH**/ ?>