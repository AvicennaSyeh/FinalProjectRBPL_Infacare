<?php $__env->startSection('content'); ?>
    ...
    <body>
        ...
        <section class="container">
            ...
            <form id="form1" action="<?php echo e(route('showuserprofile')); ?>" method="POST" enctype="multipart/form-data" class="form">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/userprofile.blade.php ENDPATH**/ ?>