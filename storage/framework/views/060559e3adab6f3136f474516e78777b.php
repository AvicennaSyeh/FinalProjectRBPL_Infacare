                    ...
                    <div class="row">
                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nurse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 bentuk-card">
                                <img src="<?php echo e($imageURL); ?>" alt="Profile Image" class="person-img" onclick="redirectToNurseRent(<?php echo e($nurse['id']); ?>)">
                                ...
                                <img src="images/icon tambah.png" alt=""
                                    ...
                                    onclick="showPopup(<?php echo e($nurse['id']); ?>)">
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp3\htdocs\rbpl-project-infagrowth\resources\views/infanurse2.blade.php ENDPATH**/ ?>