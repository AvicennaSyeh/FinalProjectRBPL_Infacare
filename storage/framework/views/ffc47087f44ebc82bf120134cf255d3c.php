        ...
        <div class="mx-[165px] my-12">
            ...
            <div class="flex flex-row gap-64 mt-6 font-lexend">
                <div class="flex flex-col gap-6 ">
                    ...
                    <div class="mt-6">
                        <form action="<?php echo e(route('updateRentHistory', $transaction)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="flex flex-col">
                    ...
                    <div class="w-[456px] ring-1 bg-white rounded-t-xl ring-gray-200 h-[134px]">
                        <div class="flex flex-row gap-10 h-full justify-center items-center">
                            ...
                            <img class="w-20 h-20" src="<?php echo e($imageSource); ?>" alt="">
                            ...
                            ?>
                                ...
                                <h1><?php echo e($namaBarang); ?></h1>

                                <p><span class="text-[#677489]">Rent Duration:</span> <?php echo e($transaction->durasiSewa); ?> Month
                                </p>
                            ...
                            <p class="mb-6">Rp. <?php echo e($harga); ?></p>
                        ...
                        <div class="mt-28">
                            ...
                            <div class="flex flex-col my-4 gap-4">
                                <div class="flex flex-row justify-between">
                                    ...
                                    <p class="text-xl">Rp <?php echo e($harga); ?></p>
                                </div>
                                <div class="flex flex-row justify-between">
                                    ...
                                    ?>
                                    <p class="text-xl">Rp<?php echo e($formattedValue); ?></p>
                                </div>
                            </div>
                            <hr class="outline-none w-[456px] h-0.5 bg-[#888F99]">
                        </div>
                        <div class="flex flex-row my-4 justify-between">
                            ...
                            ?>
                            <p class="text-xl">Rp<?php echo e($formattedTotal); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('components.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Documents\Perkuliahan duniawi\Semester 4\Rancang Bangun Perangkat Lunak\rbpl-project-infagrowth\resources\views/rentCheckout2.blade.php ENDPATH**/ ?>